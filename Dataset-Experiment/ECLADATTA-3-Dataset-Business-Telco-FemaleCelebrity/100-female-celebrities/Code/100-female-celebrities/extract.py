...
'''
# Process the original large .json file:
...
file_path = 'whole_v2.json'  # Make sure to adjust the file path as necessary
with open(file_path, 'r', encoding='utf-8') as file:
    content = file.read()
...
output_file_path = 'extracted_all.csv'  # Adjust the output file path as necessary
